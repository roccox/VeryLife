...
-(void)refreshData
{
    ...
    onePro.pic_url = @"";
    onePro.photo = [UIImage imageNamed:@"1993_1.jpg"];
    onePro.price = @"124";
    onePro.score = @"214";
    ...
    onePro.pic_url = @"";
    onePro.photo = [UIImage imageNamed:@"1993_2.jpg"];
    onePro.price = @"112";
    onePro.score = @"24";
    onePro.wap_detail_url = @"";
    onePro.item_type = @"New";
    ...
    onePro.pic_url = @"";
    onePro.photo = [UIImage imageNamed:@"1993_3.jpg"];
    onePro.price = @"512";
    onePro.score = @"24";
    onePro.wap_detail_url = @"";
    onePro.item_type = @"New";
    ...
    onePro.pic_url = @"";
    onePro.photo = [UIImage imageNamed:@"1993_4.jpg"];
    onePro.price = @"502";
    onePro.score = @"24";
    onePro.wap_detail_url = @"";
    onePro.item_type = @"New";
